...
class Inputs extends React.Component {
  ...
  submittask = (formvalue, username, project) => {
    this.props.actions().createtask['createtaskwithproject'](formvalue, username, project)
    ...
    return (
      <View style = {styles.container}>
        <TextInput style = {styles.input}
          ...
          placeholder = "Tasks entered here will go directly into the subproject."
          placeholderTextColor = "#9a73ef"
          autoCapitalize = "none"
          value = {this.state.formvalue}
          onSubmitEditing = {() => this.submittask(this.state.formvalue, this.props.state.username, this.props.project)}
